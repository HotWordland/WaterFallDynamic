...
//#import "WaterFallDynamic-Swift.h"
...
@interface MJRefreshBaseView : UIView
{
    ...
    // 子控件
    __weak CustomLabelWithChinese *_lastUpdateTimeLabel;
    __weak CustomLabelWithChinese *_statusLabel;
    __weak UIImageView *_arrowImage;
//    __weak DTIActivityIndicatorView *_activityView;
...
// 内部的控件
@property (nonatomic, weak, readonly) CustomLabelWithChinese *lastUpdateTimeLabel;
@property (nonatomic, weak, readonly) CustomLabelWithChinese *statusLabel;
