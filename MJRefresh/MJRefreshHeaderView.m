...
@property (nonatomic, strong) UIImageView *logoIndicator;
@end
...
- (void)setScrollView:(UIScrollView *)scrollView
{
    ...
    self.logoIndicator = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 194/2, 48/2)];
    [self.logoIndicator setCenter:CGPointMake(self.center.x, self.center.y + 21)];
    [self.logoIndicator setImage:[UIImage imageNamed:@"LogoIndicator"]];
    [self addSubview:self.logoIndicator];
}
